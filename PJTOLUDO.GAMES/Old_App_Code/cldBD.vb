...
Public Class cldBD
    ...
    'Public StringConexao As String = "Server=DARKTOWER\MSSERVER;Database=PJLUDOIV;UID=sa;PWD=123456;"
    Public StringConexao As String = "Server=.;Database=PJLUDOIV;UID=sa;PWD=123456;"
    'Public StringConexao As String = "Server=DAVID-PC\DAVID;Database=PJLUDOIV;UID=sa;PWD=123456;"
