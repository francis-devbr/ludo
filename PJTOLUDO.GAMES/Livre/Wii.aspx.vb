Public Class Wii
    ...
    Private Sub carregarRptExterno()
        ...
        DLAdBlock.DataSource = clsProduto.LTopProduto("Wii", 1)
        DLAdBlock.DataBind()
        dtlConsole.DataSource = clsProduto.LTopProduto("Wii", 2)
        dtlConsole.DataBind()
        rptListaTipoXbox.DataSource = clsProduto.LstTipoProdIMenu
        rptListaTipoXbox.DataBind()
        rptAcessXbox.DataSource = clsProduto.SLCategoria(3, 3)
        rptAcessXbox.DataBind()
        rptESRBXbox.DataSource = clsProduto.LstESRBIMenu
        rptESRBXbox.DataBind()

        dtCategoriaXbox.DataSource = clsProduto.SLCategoria(3, 1)
