Public Class PlayStation_3
    ...
    Private Sub carregarRptExterno()
        ...
        DLAdBlock.DataSource = clsProduto.LTopProduto("Playstation 3", 1)
        DLAdBlock.DataBind()
        dtlConsole.DataSource = clsProduto.LTopProduto("Playstation 3", 2)
        dtlConsole.DataBind()
        rptListaTipoXbox.DataSource = clsProduto.LstTipoProdIMenu
        rptListaTipoXbox.DataBind()
        rptAcessXbox.DataSource = clsProduto.SLCategoria(2, 3)
        rptAcessXbox.DataBind()
        rptESRBXbox.DataSource = clsProduto.LstESRBIMenu
        rptESRBXbox.DataBind()

        dtCategoriaXbox.DataSource = clsProduto.SLCategoria(2, 1)
