Public Class PC
    ...
    Private Sub carregarRptExterno()
        ...
        DLAdBlock.DataSource = clsProduto.LTopProduto("PC", 1)
        DLAdBlock.DataBind()
        dtlConsole.DataSource = clsProduto.LTopProduto("PC", 2)
        dtlConsole.DataBind()
        rptListaTipoXbox.DataSource = clsProduto.LstTipoProdIMenu
        rptListaTipoXbox.DataBind()
        rptAcessXbox.DataSource = clsProduto.SLCategoria(5, 3)
        rptAcessXbox.DataBind()
        rptESRBXbox.DataSource = clsProduto.LstESRBIMenu
        rptESRBXbox.DataBind()

        dtCategoriaXbox.DataSource = clsProduto.SLCategoria(5, 1)
