Public Class PS_Vita
    ...
    Private Sub carregarRptExterno()
        ...
        DLAdBlock.DataSource = clsProduto.LTopProduto("PS Vita", 1)
        DLAdBlock.DataBind()
        dtlConsole.DataSource = clsProduto.LTopProduto("PS Vita", 2)
        dtlConsole.DataBind()
        rptListaTipoXbox.DataSource = clsProduto.LstTipoProdIMenu
        rptListaTipoXbox.DataBind()
        rptAcessXbox.DataSource = clsProduto.SLCategoria(7, 3)
        rptAcessXbox.DataBind()
        rptESRBXbox.DataSource = clsProduto.LstESRBIMenu
        rptESRBXbox.DataBind()

        dtCategoriaXbox.DataSource = clsProduto.SLCategoria(7, 1)
